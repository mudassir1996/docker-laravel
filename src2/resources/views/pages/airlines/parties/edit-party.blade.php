            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="#" class="text-muted">Edit Party</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card card-custom">
                        <div class="card-header flex-wrap py-5">
                            <div class="card-title">
                                <h3 class="card-label">Edit Party
                        ...
                        <div class="card-body">
                            <!--begin::Form-->
                            <form method="post" action="{{ route('parties.update', $party->id) }}" id="add_party_form"
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="col-xl-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="party_title" class="form-control   "
                                                    value="{{ $party->party_title }}" name="party_title"
                                                    placeholder="Title" />
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="form-group">
                                                <label>Reg. No</label>
                                                <input type="text" class="form-control   " value="{{ $party->party_regno }}"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-xl-6">
                                            ...
                                            <div class="form-group">
                                                <label>Phone</label>
                                                <input type="text" class="form-control   " value="{{ $party->party_phone }}"
                                                    name="party_phone" placeholder="Phone" />
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input type="text" class="form-control   " value="{{ $party->party_email }}"
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control   "
                                                    value="{{ $party->party_address }}" name="party_address"
                                                    placeholder="Address" />
                                            </div>
                                            <!--end::Input-->
                                        </div>
                                                    ...
                                                    <span class="switch switch-outline switch-icon switch-success">
                                                        <label>
                                                            <input type="checkbox" name="allow_credit"
                                                                {{ $party->allow_credit == 1 ? 'checked' : '' }} value="1" />
                                                            <span></span>
                                                        </label>
                                                    </span>
                                                </div>
                                        ...
                                        <div class="col-xl 12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control   " id="exampleTextarea"
                                                    ...
                                                    rows="5">{{ $party->party_description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-0">
                                        <div class="image-input image-input-outline" id="kt_image_1">
                                            ...
                                            @php
                                                $image = Storage::disk('public')->exists('parties/' . $party->party_feature_img) ? asset('storage/parties/' . $party->party_feature_img) : asset('storage/' . $party->party_feature_img);
                                            @endphp
