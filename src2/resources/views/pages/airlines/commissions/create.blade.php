...
@section('title', 'Add Outlet Commission')
@section('content')
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="#" class="text-muted">Add Commission</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card card-custom">
                        <div class="card-header flex-wrap py-5">
                            <div class="card-title">
                                <h3 class="card-label">Add Outlet Commission
                        ...
                        <div class="card-body">
                            <!--begin::Form-->
                            <form method="post" action="{{ route('outlet-commissions.store') }}" id="add_commission_form"
                                        ...
                                        <div class="col-xl-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control selectpicker" id="commission_type"
                                                    ...
                                                    <option value="value"
                                                        {{ old('commission_type') == 'value' ? 'selected' : '' }}>Value
                                                    </option>
                                                </select>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control selectpicker" id="commission_status"
                                                    ...
                                                    <option value="active"
                                                        {{ old('commission_status') == 'active' ? 'selected' : '' }}>
                                                        Active
                                                    </option>
