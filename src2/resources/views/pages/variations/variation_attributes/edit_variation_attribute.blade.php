...
@section('title', 'Edit Variation Attributes')
@section('content')
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="#" class="text-muted">Edit Variation Attribute</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card card-custom">
                        <div class="card-header flex-wrap py-5">
                            <div class="card-title">
                                <h3 class="card-label">Edit Variation Attribute
                        ...
                        <div class="card-body">
                            <!--begin::Form-->
                            <form method="post"
                                action="{{ route('variation-attributes.update', $variation_attribute->id) }}"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group">
                                                ...
                                                <input id="kt_tagify_1" class="form-control   tagify"
                                                    value="{{ $variation_attribute->value }}" name="value"
                                                ...
                                                <select class="form-control   selectpicker" title="Select Variation"
                                                    ...
                                                    @foreach ($variations as $variation)
                                                        <option value="{{ $variation->id }}"
                                                            {{ $variation_attribute->variation_id == $variation->id ? 'selected' : '' }}>
