...
@section('title', 'Edit Employee Attendance Meta Transaction')
@section('content')
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item">
                            <a href="{{ route('employee-attendance.index') }}" class="text-muted">All Employee
                                Attendance Meta Transaction</a>
                        </li>
                        <li class="breadcrumb-item">
                            <a href="#" class="text-muted">Edit Employee Attendance Meta Transaction</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card card-custom">
                        <div class="card-header flex-wrap py-5">
                            <div class="card-title">
                                <h3 class="card-label">Edit Employee Attendance Meta Transaction
                        ...
                        <div class="card-body">
                            <!--begin::Form-->
                            <form method="post"
                                action="{{ route('employee-attendance-meta.update', $employee_attendance_meta_transaction->id) }}"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-xl-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control   selectpicker" data-live-search="true"
                                                    data-size="5" name="employee_id" id="employee">
                                                    @foreach ($employees as $employee)
                                                        <option value="{{ $employee->id }}"
                                                            {{ $employee->id == $employee_attendance_meta_transaction->employee_id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control   selectpicker" data-live-search="true"
                                                    data-size="5" name="employee_attendance_meta_id">
                                                    @foreach ($employee_attendance_metas as $employee_attendance_meta)
                                                        <option value="{{ $employee_attendance_meta->id }}"
                                                            {{ $employee->id == $employee_attendance_meta_transaction->employee_attendance_meta_id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control  "
                                                    value="{{ $employee_attendance_meta_transaction->date }}"
                                                    placeholder="Select Date" name="date" readonly id="kt_datetimepicker_3">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-xl-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control  "
                                                    value="{{ $employee_attendance_meta_transaction->per_hour_wage }}"
                                                    name="per_hour_wage" id="per-hour-wage">
                                        ...
                                        <div class="col-xl-4">
                                            <div class="form-group">
                                                <label>Hours</label>
                                                <input type="text" class="form-control  "
                                                    value="{{ $employee_attendance_meta_transaction->hours }}"
                                                    name="hours" id="hours">
                                        ...
                                        <div class="col-xl-4">
                                            <div class="form-group">
                                                <label>Amount</label>
                                                <input type="text" class="form-control  "
                                                    value="{{ $employee_attendance_meta_transaction->amount }}"
...
@section('scripts')
    <script>
        var default_per_hour_wage = $('#per-hour-wage').val();
