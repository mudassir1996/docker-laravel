            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="#" class="text-muted">Edit Employee Salary</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card card-custom">
                        <div class="card-header flex-wrap py-5">
                            <div class="card-title">
                                <h3 class="card-label">Edit Employee Salary
                        ...
                        <div class="card-body">
                            <!--begin::Form-->
                            <form method="post" action="{{ route('employee-salary.update', $employee_salary->id) }}"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-xl-4">
                                            ...
                                            <input type="text" class="form-control  "
                                                value="{{ $employee_salary->employee_name }}" disabled>
                                        </div>
                                        <div class="col-xl-4">
                                            <!--begin::Input-->
                                            <div class="form-group">
                                                ...
                                                <select class="form-control    selectpicker" data-live-search="true"
                                                    ...
                                                    <option value="{{ $employee_salary->salary_type_id }}">
                                                        @foreach ($salary_types as $salary_type)
                                                            @if ($employee_salary->salary_type_id == $salary_type->id)
                                                                {{ $salary_type->title }}
                                                            @endif
                                                        @endforeach
                                                    </option>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control  "
                                                    value="{{ $employee_salary->salary_amount }}" name="salary_amount"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-xl-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control   "
                                                    value="{{ $employee_salary->working_hours_per_day }}"
                                        ...
                                        <div class="col-xl-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control   "
                                                    value="{{ $employee_salary->joining_date }}" name="joining_date"
                                        ...
                                        <div class="col-xl-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control   "
                                                    value="{{ $employee_salary->starting_date }}" name="starting_date"
