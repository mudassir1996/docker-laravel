                    ...
                    <div class="card card-custom">
                        <div class="card-header flex-wrap py-5">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="dropdown dropdown-inline mr-2">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        ...
                                        <ul class="navi flex-column navi-hover py-2">
                                            ...
                                            <li class="navi-item">
                                                <a href="{{route('print.products')}}" target="_blank" id="export_print" class="navi-link">
                                ...
                                <!--end::Button-->
                                <!--begin::Button-->
                                <a href="{{route('invoice.index')}}" class="btn btn-success font-weight-bolder mx-2">
                                    <span class="svg-icon svg-icon-md">
                                        <!--begin::Svg Icon -->
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        ...
                                        <!--end::Svg Icon-->
                                    </span>Create Invoice From Templates</a>
                                <!--end::Button-->
                                ...
                                <tbody>
                                    @foreach ($invoices as $invoice)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn p-0" title="Print" href="{{route('invoice.print', $invoice->id)}}">
