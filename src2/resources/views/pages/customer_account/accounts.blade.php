                    ...
                    <div class="card card-custom">
                        <div class="card-header flex-wrap py-5">
                            <div class="card-title">
                                <h3 class="card-label">Manage Customer Account Transaction
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="dropdown dropdown-inline mr-2">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        ...
                                        <ul class="navi flex-column navi-hover py-2">
                                            ...
                                            <li class="navi-item">
                                                <a href="{{ route('print.customer_accounts')}} " target="_blank" class="navi-link">
                                ...
                                <!--begin::Button-->
                                <a href="{{route('customer-accounts.create')}}" class="btn btn-primary font-weight-bolder">
                                    <span class="svg-icon svg-icon-md">
                                        <!--begin::Svg Icon -->
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <table class="table table-separate table-head-custom nowrap table-checkable" id="kt_datatable_account_transactions">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{substr($customer_account->description, 0, 40)}}...</td>
                                        <td>
                                        ...
                                        <td>{{$customer_account->updated_at}}</td>
                                         <td>
                                            @if(!Auth::guard('web')->check())
                                                ...
                                                <a class="btn p-0" title="View" href="{{route('customer-accounts.show',$customer_account->id)}}">
                                                    <i class="text-primary h3 la la-eye"></i>
                                                </a>
                                                <a class="btn p-0" target="__blank" title="Print" href="/outlets/customer-accounts/print-customer-transaction/{{ $customer_account->id }}">
