                    ...
                    <div class="card card-custom">
                        <div class="card-header flex-wrap py-5">
                            <div class="card-title">
                                <h3 class="card-label">Add Customer Payment
                                                    ...
                                                    @foreach ($customers as $customer)
                                                        @if (!$loop->last)
                                                            <option value="{{ $customer->id }}"
                                                                ...
                                                                data-allow-credit="{{ $customer->allow_credit }}">
...
@section('scripts')
    ...
    <script>
        ...
        $('#get_order').on('click', function() {
            ...
            $.ajax({
                url: "{{ url('get-credit-orders') }}?customer_id=" + customer_id,
                type: "Get",
        ...
        $('#customer').on('change', function() {
            $('[name="hidden_allow_credit"]').val($('#customer option:selected').attr('data-allow-credit'));
        });
    </script>
