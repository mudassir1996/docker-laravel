                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item">
                            <a href="{{ route('customer-accounts.index') }}" class="text-muted">All Transaction</a>
                        </li>
                        <li class="breadcrumb-item">
        ...
        <div class="container-fluid px-0">
            ...
            <div class="d-flex flex-row">
                ...
                <div class="flex-row-fluid">
                    <div class="card mb-5">
                        <form action="{{ route('customer-transaction.filter') }}" method="post">
                            @csrf
                                        ...
                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                            ...
                                            <ul class="navi flex-column navi-hover py-2">
                                                ...
                                                <li class="navi-item">
                                                    ...
                                                    @endphp
                                                    <a href="{{ route('print.customer_transactions', $filter_data) }}"
                                    ...
                                    @if (!$customer_transactions->isEmpty())
                                        @foreach ($customer_transactions as $customer_transaction)
                                            <tr>
                                                ...
                                                <td>{{ date('D, d M Y', strtotime($customer_transaction->payment_date)) }}
                                                </td>
                                                <td>{{ substr($customer_transaction->description, 0, 40) }}...</td>
                                                <td>{{ $customer_transaction->amount }}</td>
                                                <td>{{ ucfirst($customer_transaction->payment_type) }}</td>
                                ...
                                @if (!$customer_transactions->isEmpty())
                                    <tr>
                                        <td class="font-weight-bolder">
                                            {{ date('D, d M Y', strtotime($customer_transactions->last()->payment_date)) }}
                                        </td>
