        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Outlet Account Transaction</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item">
                            <a href="{{ route('outlet-payment-transactions.index') }}" class="text-muted">All
                                Transactions</a>
                        </li>
                        <li class="breadcrumb-item">
                    ...
                    <div class="card card-custom">
                        <div class="card-header flex-wrap py-5">
                            <div class="card-title">
                                <h3 class="card-label">Add Transaction
                        ...
                        <div class="card-body">
                            <!--begin::Form-->
                            <form method="post" action="{{ route('outlet-payment-transactions.store') }}"
                                id="outlet_transaction_form">
                                @csrf
                                <div class="card-body">
                                        ...
                                        @if (App\Classes\Subscriber::isPremium())
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control    selectpicker" id="customer"
                                                        data-live-search="true" data-size="5" title="Select Customer"
                                                        name="customer_id">
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control   " id="order" name="order_id"
                                                    placeholder="Add Order ID" autocomplete="off" />
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control   " data-live-search="true" data-size="5"
                                                    id="payment_type_dropdown" name="transaction_type">
                                                    {{-- <option value="">Select Payment Type</option> --}}
                                                    <option value="debit"
                                                        {{ old('transaction_type') == 'debit' ? 'selected' : '' }}>
                                                        Debit
                                                    </option>
                                                    <option value="credit"
                                                        {{ old('transaction_type') == 'credit' ? 'selected' : '' }}>
                                                        Credit
                                                    </option>
