                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="product_barcode"
                                                    ...
                                                    value="{{ $product->product_barcode }}" name="product_barcode"
                                                    placeholder="Barcode" />
                                                <p class="text-danger"> {{ $errors->first('product_barcode') }}</p>
                                            </div>
                                            <!--end::Input-->
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <select class="form-control selectpicker   " title="Select Company"
                                                data-live-search="true" data-size=5 id="company" name="company_id">
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <select class="form-control selectpicker   " title="Select Category"
                                                data-live-search="true" data-size=5 id="category" name="category_id">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            ...
                                            <select class="form-control   " id="exampleSelect1" name="product_status">
                                                <option @if ($product->product_status == 'Active') selected @endif>
                                                    Active</option>
                                                <option @if ($product->product_status == 'Inactive') selected @endif>
                                                    Inactive</option>
                                            </select>
                                            <!--end::Input-->
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group ">
                                                <label class="col-3 col-form-label">Allow Half</label>
                                                <div class="col-4">
                                                    <span class="switch switch-outline switch-icon switch-success">
                                                        <label>
                                                            <input type="checkbox" name="product_allow_half" value="1"
                                                                @if ($product->product_allow_half == 1) checked @endif>
                                                            <span></span>
                                                        </label>
                                                    </span>
                                                </div>
                                    ...
                                    <div class="form-group mb-0">
                                        <div class="image-input image-input-outline" id="kt_image_1">
                                            @php
                                                $image = Storage::disk('public')->exists('products/' . $product->product_feature_img) ? asset('storage/products/' . $product->product_feature_img) : asset('storage/' . $product->product_feature_img);
                                            @endphp
