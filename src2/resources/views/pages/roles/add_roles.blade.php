            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="#" class="text-muted">Add Roles</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="role_title" name="role_title"
                                                    ...
                                                    value="{{ old('role_title') }}" placeholder="Role Title" />
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control   selectpicker " title="Select Permission"
                                                        data-size="5" data-live-search="true" data-actions-box="true"
                                                        name="permission_id[]" multiple>
                                                        @foreach ($permissions as $id => $permission)
                                                            <option value="{{ $id }}"
                                                                {{ in_array($id, old('permission_id', [])) ? 'selected' : '' }}>
                                                                {{ $permission }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
