...
<body>
    ...
    <div class="container">
        ...
        <div style="text-align:center;font-size:18px;">
            Party Title: {{ $party_transactions->first()->party_title }}
        </div>
        <div class="mt-5" style="text-align:center;">
            <h2>Party Transactions Summary</h2>
        </div>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{date('D, d M Y', strtotime($party_transaction->payment_date))}}</td>
            ...
            <tfoot>
                @if (!$party_transactions->isEmpty())
                <tr>
                    <td class="font-weight-bolder">{{date('D, d M Y', strtotime($party_transactions->last()->payment_date))}}</td>
