...
<head>
    <meta charset="utf-8" />
    {{-- Title Section --}}
    <title>{{ config('app.name') }} | Low Stock</title>
...
<body>
    ...
    <div class="container">
        ...
        <table class="table table-borderless border border-dark ">
            ...
            <tbody>
                @foreach ($low_stocks as $product_stock)
                    <tr>
                        <td class="border-right border-dark align-middle">{{ $product_stock->product_title }}</td>
                        <td class="border-right border-dark align-middle">{{ $product_stock->company_title }}</td>
                        <td class="border-right border-dark align-middle">{{ $product_stock->units_in_stock }}</td>
                        <td class="align-middle">{{ $product_stock->minimum_threshold }}</td>
