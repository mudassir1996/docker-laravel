        ...
        <table class="table table-borderless border border-dark ">
            ...
            <tbody>
                @foreach ($categories as $category)
                    <tr>
                        <td class="border-right border-dark align-middle">{{ $category->category_title }}</td>
                        <td class="border-right border-dark align-middle">{{ $category->category_description }}</td>
                        <td class="border-right border-dark align-middle">{{ $category->employee_name }}</td>
                        <td class="border-right border-dark align-middle">{{ $category->created_at }}</td>
