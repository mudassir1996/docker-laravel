                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item">
                            <a href="{{ route('payment-methods.index') }}" class="text-muted">All Payment Methods</a>
                        </li>
                        <li class="breadcrumb-item">
                            <a href="#" class="text-muted">Edit Payment Method</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card card-custom">
                        <div class="card-header flex-wrap py-5">
                            <div class="card-title">
                                <h3 class="card-label">Edit Payment Method
                        ...
                        <div class="card-body">
                            <!--begin::Form-->
                            <form method="post" action="{{ route('payment-methods.update', $payment_method->id) }}"
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="payment_title" id="payment_title"
                                                    class="form-control   {{ $errors->first('payment_title') ? 'is-invalid' : '' }}"
                                                    value="{{ $payment_method->payment_title }}"
                                                    placeholder="Payment Title" />
                                                <p class="text-danger"> {{ $errors->first('payment_title') }}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="phone" id="phone" class="form-control  "
                                                    value="{{ $payment_method->phone }}" placeholder="Phone" />
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="address" id="address" class="form-control   "
                                                    value="{{ $payment_method->address }}" placeholder="Address" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control   " id="exampleTextarea" name="payment_description"
                                            rows="5">{{ $payment_method->payment_description }}</textarea>
                                    </div>
