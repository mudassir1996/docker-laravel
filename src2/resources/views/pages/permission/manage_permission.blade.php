                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item">
                            <a href="" class="text-muted">All Permissions</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div class="d-flex flex-row">
                ...
                <div class="flex-row-fluid">
                    ...
                    <div class="card card-custom">
                        <div class="card-header flex-wrap py-5">
                            <div class="card-title">
                                <h3 class="card-label">Permission
                                    <span class="d-block text-muted pt-2 font-size-sm">All Permissions</span>
                                </h3>
                            </div>
                        ...
                        <div class="card-body">
                            <!--begin: Datatable-->
                            <table class="table table-separate table-head-custom nowrap table-checkable" id="kt_datatable">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Title</th>
