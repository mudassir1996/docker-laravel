            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="#" class="text-muted">View Supplier</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                            ...
                            <div class="card card-custom card-stretch gutter-b">
                                <div class="card-body p-15 pb-20">
                                    <div class="row mb-17">
                                        <div class="col-xxl-3 mb-11 mb-xxl-0">
                                            ...
                                            <div class="card card-custom card-stretch">
                                                <div class="bgi-no-repeat bgi-size-cover rounded shadow-sm min-h-265px" style='background-image: url("{{Storage::disk('public')->exists('suppliers/'.$supplier->supplier_feature_img)?asset('storage/suppliers/'.$supplier->supplier_feature_img):asset('storage/'.$supplier->supplier_feature_img)}}")'></div>
                                                
                                            </div>
                                            <!--end::Image-->
                                        </div>
                                        <div class="col-xxl-7 pl-xxl-11">
                                            <h2 class="font-weight-bolder text-dark mb-7" style="font-size: 32px;">{{$supplier->supplier_title}}</h2>
                                            {{-- <div class="font-size-h2 mb-7 text-dark-50">From
                                                <span class="text-info font-weight-boldest ml-2">$299.00</span>
                                            </div> --}}
                                            <div class="line-height-xl">{{$supplier->supplier_description}}</div>
                                        </div>
                                    </div>
                                    <div class="row mb-6">
                                        <!--begin::Info-->
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                                ...
                                                <span class="text-muted font-weight-bolder font-size-lg">{{$supplier->supplier_address ?? '-'}}</span>
                                            </div>
                                        </div>
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                                <span class="text-dark font-weight-bold mb-4">CNIC</span>
                                                <span class="text-muted font-weight-bolder font-size-lg">{{$supplier->supplier_cnic ?? '-'}}</span>
                                            </div>
                                        </div>
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                                <span class="text-dark font-weight-bold mb-4">Email</span>
                                                <span class="text-muted font-weight-bolder font-size-lg">{{$supplier->supplier_email ?? '-'}}</span>
                                            </div>
                                        </div>
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                        ...
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                                ...
                                                <span class="text-muted font-weight-bolder font-size-lg">{{$supplier->created_at}}</span>
                                            </div>
                                        </div>
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                                <span class="text-dark font-weight-bold mb-4">Updated At</span>
                                                <span class="text-muted font-weight-bolder font-size-lg">{{$supplier->updated_at}}</span>
                                            </div>
                                        </div>
                                        <!--end::Info-->
                                    </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        @can('supplier_edit')
                                        <a href="{{ route('suppliers.edit',$supplier->id)}}" class="btn btn-primary btn-shadow font-weight-bolder mr-6 px-8 font-size-sm">
                                            <span class="svg-icon">
                                        ...
                                        <form action="{{ route('suppliers.destroy',$supplier->id)}}" id="delete_item_from{{$supplier->id}}" method="post">
                                            ...
                                            @if(!Auth::guard('web')->check())
                                            @can('supplier_delete')
                                            <a onclick="deleteConfirmation('delete_item_from{{$supplier->id}}')" class="btn btn-danger btn-shadow font-weight-bolder px-8 font-size-sm">
                                                <span class="svg-icon">
