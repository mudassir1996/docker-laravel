                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item">
                            <a href="{{route('supplier-accounts.index')}}" class="text-muted">All Transactions</a>
                        </li>
                        <li class="breadcrumb-item">
                                    ...
                                    <div class="row mb-17">
                                        ...
                                        <div class="col-xxl-12 ">
                                            ...
                                            <div class="font-size-h2 mb-7 text-dark-50">Payment
                                                <span class="text-info font-weight-boldest ml-2">PKR {{$supplier_account->amount}}</span>
                                            </div>
                                            <div class="line-height-xl">{{$supplier_account->description}}</div>
                                        </div>
                                    </div>
                                    <div class="row mb-6">
                                        <!--begin::Info-->
                                        ...
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                                ...
                                                <span class="text-muted font-weight-bolder font-size-lg">{{$supplier_account->payment_date}}</span>
                                            </div>
                                        </div>
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                                <span class="text-dark font-weight-bold mb-4">Order ID</span>
                                                <span class="text-muted font-weight-bolder font-size-lg">{{$supplier_account->order_id}}</span>
                                            </div>
                                        </div>
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                        ...
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                                ...
                                                <span class="text-muted font-weight-bolder font-size-lg">{{$supplier_account->created_at}}</span>
                                            </div>
                                        </div>
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                                <span class="text-dark font-weight-bold mb-4">Updated At</span>
                                                <span class="text-muted font-weight-bolder font-size-lg">{{$supplier_account->updated_at}}</span>
                                            </div>
                                        </div>
                                        <!--end::Info-->
                                    </div>
