                    ...
                    <div class="card card-custom">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('categories.update', $category->id) }}"
                                id="add_category_form" enctype="multipart/form-data">
                                @method('PATCH')
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="category_title"
                                            class="form-control    {{ $errors->first('category_title') ? 'is-invalid' : '' }}"
                                            value="{{ $category->category_title }}" name="category_title"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control   " id="exampleTextarea" name="category_description"
                                    ...
                                    <div class="form-group mb-0">
                                        <div class="image-input image-input-outline" id="kt_image_1">
                                            ...
                                            <label
                                                ...
                                                <input type="file" name="category_feature_img" accept=".jpg,.png" />
                                        ...
                                        <span class="form-text">Category Image</span>
                                        @error('category_feature_img')
                                            {{ $message }}
                                        @enderror
                                    </div>
...
@section('scripts')
    <script>
        $('#btn-submit').click(() => {
            ...
            $('#category_title').val(category_title.trim());
        });
    </script>
    <script>
