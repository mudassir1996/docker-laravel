            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="#" class="text-muted">View Company</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                            ...
                            <div class="card card-custom card-stretch gutter-b">
                                <div class="card-body p-15 pb-20">
                                    <div class="row mb-17">
                                        <div class="col-xxl-3 mb-11 mb-xxl-0">
                                            ...
                                            <div class="card card-custom card-stretch">
                                                <div class="bgi-no-repeat bgi-size-cover rounded shadow-sm min-h-265px" style="background-image: url('{{Storage::disk("public")->exists("companies/".$company->company_feature_img)?asset("storage/companies/".$company->company_feature_img):asset("storage/".$company->company_feature_img)}}')"></div>
                                            </div>
                                            <!--end::Image-->
                                        </div>
                                        <div class="col-xxl-7 pl-xxl-11">
                                            <h2 class="font-weight-bolder text-dark mb-7" style="font-size: 32px;">{{$company->company_title}}</h2>
                                             <div class="font-size-h4 mb-7 text-dark-50">Total products
                                                <span class="text-info font-weight-boldest ml-2">{{$total_products}}</span>
                                            </div>
                                            <div class="line-height-xl">{{$company->company_description}}</div>
                                        </div>
                                    </div>
                                    <div class="row mb-6">
                                        <!--begin::Info-->
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                                ...
                                                <span class="text-muted font-weight-bolder font-size-lg">{{$company->company_address??'-'}}</span>
                                            </div>
                                        </div>
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                                <span class="text-dark font-weight-bold mb-4">Email</span>
                                                <span class="text-muted font-weight-bolder font-size-lg">{{$company->company_email??'-'}}</span>
                                            </div>
                                        </div>
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                                <span class="text-dark font-weight-bold mb-4">Phone</span>
                                                <span class="text-muted font-weight-bolder font-size-lg">{{$company->company_phone??'-'}}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                                ...
                                                <span class="text-muted font-weight-bolder font-size-lg">{{$company->created_at}}</span>
                                            </div>
                                        </div>
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                                <span class="text-dark font-weight-bold mb-4">Updated At</span>
                                                <span class="text-muted font-weight-bolder font-size-lg">{{$company->updated_at}}</span>
                                            </div>
                                        </div>
                                        <!--end::Info-->
                                    </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        @can('company_edit')
                                        <a href="{{ route('companies.edit',$company->id)}}" class="btn btn-primary btn-shadow font-weight-bolder mr-6 px-8 font-size-sm">
                                            <span class="svg-icon">
                                        ...
                                        @endif
                                        <form action="{{ route('companies.destroy',$company->id)}}" id="delete_item_from{{$company->id}}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            @if(!Auth::guard('web')->check())
                                            @can('company_delete')
                                            <a onclick="deleteConfirmation('delete_item_from{{$company->id}}')" class="btn btn-danger btn-shadow font-weight-bolder px-8 font-size-sm">
                                                <span class="svg-icon">
