            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="#" class="text-muted">Edit Company</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="company_title"
                                                    ...
                                                    value="{{ $company->company_title }}" name="company_title"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control   " id="exampleTextarea" name="company_description"
                                            rows="5">{{ $company->company_description }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group mb-0">
                                        <div class="image-input image-input-outline" id="kt_image_1">
                                            @php
                                                $image = Storage::disk('public')->exists('companies/' . $company->company_feature_img) ? asset('storage/companies/' . $company->company_feature_img) : asset('storage/' . $company->company_feature_img);
                                            @endphp
