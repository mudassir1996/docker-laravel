                    ...
                    <form method="POST" action="{{ route('register') }}" class="form" novalidate="novalidate" id="kt_login_signup_form">
                        ...
                        <div class="pb-13 pt-lg-0 pt-5">
                            ...
                            <span class="text-muted font-weight-bold font-size-h4">Already have an account?
                                <a href="{{ route('login') }}" id="kt_login_signup" class="text-primary font-weight-bolder">Sign in Here</a></span>
                        </div>
                        <!--end::Title-->
                        <!--begin::Form group-->
                        <div class="form-group">
                            <input class="form-control form-control-solid h-auto py-5 px-6 rounded-lg font-size-h6 @error('username') is-invalid @enderror" type="text" placeholder="User Name" value="{{old('username')}}" name="username" autocomplete="off" />
                        ...
                        <!--begin::Form group-->
                        <div class="form-group">
                            <input class="form-control form-control-solid h-auto py-5 px-6 rounded-lg font-size-h6 @error('email') is-invalid @enderror" type="email" placeholder="Email" value="{{old('email')}}" name="email" autocomplete="off" />
                            @error('email')
                            <div class="fv-plugins-message-container">
                        ...
                        <div class="form-group">
                            <label class="checkbox mb-0">
                                ...
                                <a href="#">&nbspterms and conditions</a>.
                                <span></span></label>
                        </div>
                        <!--end::Form group-->
                        <!--begin::Form group-->
