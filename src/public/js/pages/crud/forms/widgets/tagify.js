...
var KTTagifyDemos = function () {
  var wizard= () => {
    ...
    tagify = new Tagify(input); // "remove all tags" button event listener

     var input2 = document.getElementById('kt_tagify_2'),
        // init Tagify script on the above inputs
    tagify = new Tagify(input2); // "remove all tags" button event listener

     var input3 = document.getElementById('kt_tagify_3'),
        // init Tagify script on the above inputs
    tagify = new Tagify(input3); // "remove all tags" button event listener
  }
  // Private functions
