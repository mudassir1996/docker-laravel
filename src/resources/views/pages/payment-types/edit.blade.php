            ...
            <div class="d-flex flex-row">
                ...
                <div class="flex-row-fluid">
                    ...
                    <div class="card card-custom">
                        ...
                        <div class="card-body">
                            <!--begin::Form-->
                            <form method="post" action="{{ route('payment-types.update', $payment_type->id) }}"
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="title"
                                                    ...
                                                    value="{{ $payment_type->title }}" name="title" placeholder="Title" />
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="value"
                                                    ...
                                                    value="{{ $payment_type->value }}" name="value"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control   " id="exampleTextarea" name="description"
                                            rows="5">{{ $payment_type->description }}</textarea>
