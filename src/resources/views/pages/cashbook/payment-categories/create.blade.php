            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="#" class="text-muted">Add Payment Category</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card card-custom">
                        <div class="card-header flex-wrap py-5">
                            <div class="card-title">
                                <h3 class="card-label">Add Payment Category
                            ...
                            <form method="post" action="{{ route('payment-categories.store') }}"
                                ...
                                <div class="form-group row mb-2">
                                    <div class="col-xl-6">
                                        ...
                                        <input type="text" name="payment_category_title" id="payment_category_title"
                                            ...
                                            value="{{ old('payment_category_title') }}" placeholder="Title" />
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <select class="form-control" id="payment_category_status"
                                            ...
                                            <option value="active"
                                                {{ old('payment_category_status') == 'active' ? 'selected' : '' }}>
                                                Active</option>
                                            <option value="inactive"
                                                {{ old('payment_category_status') == 'inactive' ? 'selected' : '' }}>
                                                Inactive
                                            </option>
                                        </select>
                                        <!--end::Input-->
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="exampleTextarea"
                                        ...
                                        rows="5">{{ old('payment_category_description') }}</textarea>
                                </div>
