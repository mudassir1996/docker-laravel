    ...
    <div class="card-body pt-0">
        ...
        <div class="mb-10">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="d-flex flex-column flex-grow-1">
                    <a href="#" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Top Sales</a>
        ...
        <div class="mb-10">
            ...
            <div class="d-flex align-items-center">
                ...
                {{-- Text --}}
                <div class="d-flex flex-column flex-grow-1">
                    <a href="#" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Popular Sales</a>
                    <span class="text-muted font-weight-bold">5 day ago</span>
                </div>
            </div>
        ...
        <div class="">
            ...
            <div class="d-flex align-items-center">
                ...
                {{-- Text --}}
                <div class="d-flex flex-column flex-grow-1">
                    <a href="#" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">New Sales</a>
                    <span class="text-muted font-weight-bold">5 day ago</span>
                </div>
            </div>
