            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="#" class="text-muted">Add Payment Methods</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card card-custom">
                        <div class="card-header flex-wrap py-5">
                            <div class="card-title">
                                <h3 class="card-label">Add Payment Methods
                        ...
                        <div class="card-body">
                            <!--begin::Form-->
                            <form method="post" action="{{ route('payment-methods.store') }}" calss="payment_method_form"
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="payment_title" id="payment_title"
                                                    ...
                                                    value="{{ old('payment_title') }}" placeholder="Payment Title" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control   " id="exampleTextarea" name="payment_description"
                                            rows="5">{{ old('payment_description') }}</textarea>
                                    </div>
...
@section('scripts')
    <script>
        $('#btn-submit').click(() => {
            ...
            $('#payment_title').val(title.trim());
        });
    </script>
    <script src="{{ asset('js/payment_methods/form_validation.js') }}"></script>
