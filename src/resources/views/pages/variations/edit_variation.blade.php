        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Variations</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item">
                            <a href="{{ route('variations.index') }}" class="text-muted">All Variations</a>
                        </li>
                        <li class="breadcrumb-item">
                            <a href="#" class="text-muted">Edit Variations</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card card-custom">
                        <div class="card-header flex-wrap py-5">
                            <div class="card-title">
                                <h3 class="card-label">Edit Variations
                                    ...
                                    <div class="form-group row">
                                        <div class="col-xl-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control  "
                                                    value="{{ $variation->variation_title }}" name="variation_title">
                                                <p class="text-danger"> {{ $errors->first('variation_title') }}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="form-group">
                                                ...
                                                <input id="kt_tagify_1" class="form-control   tagify" name="value" value="
                                                        @foreach ($variation->variation_attributes as $variation_attribute) @if ($loop->last)
                                                            {{ $variation_attribute->value }}
                                                        @else
                                                            {{ $variation_attribute->value . ',' }} @endif
                                                        @endforeach" placeholder="type...">
                                        ...
                                        <div class="col-xl-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control   selectpicker" data-live-search="true"
                                                    data-size="5" name="status">

                                                    <option value="active"
                                                        {{ $variation->status == 'active' ? 'selected' : '' }}>
                                                        Active</option>

                                                    <option value="inactive"
                                                        {{ $variation->status == 'inactive' ? 'selected' : '' }}>
                                                        Inactive</option>
