                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            ...
                            <a href="" class="text-muted">All Variations</a>
                    ...
                    <div class="card card-custom">
                        ...
                        <div class="card-header flex-wrap py-5">
                            ...
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Variations

                                    <span class="d-block text-muted pt-2 font-size-sm">Manage Variations</span>
                            ...
                            <div class="card-toolbar">
                                ...
                                @if (!Auth::guard('web')->check())
                                    ...
                                    @can('employee_create')
                                        ...
                                        <a href="{{ route('variations.create') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                   <ol>
                                                        @foreach ($variation->variation_attributes as $variation_attribute)
                                                            <li>{{$variation_attribute->value}}</li>
                                                        @endforeach
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('variations.destroy', $variation->id) }}"
                                                        id="delete_item_from{{ $variation->id }}" method="post">
                                                        ...
                                                        @if (!Auth::guard('web')->check())
                                                            ...
                                                            @can('product_delete')
                                                                ...
                                                                <a class="btn p-0" title="Delete"
                                                                    onclick="deleteConfirmation('delete_item_from{{ $variation->id }}')"><i
