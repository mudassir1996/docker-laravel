            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="#" class="text-muted">Low Stock</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                            ...
                            <div class="card-toolbar">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        ...
                                        <ul class="navi flex-column navi-hover py-2">
                                            ...
                                            <li class="navi-item">
                                                ...
                                                @endphp
                                                <a href="{{ route('print.low_stock', $filter_data) }}" target="_blank"
                                                    class="navi-link">
                                            ...
                                            <li class="navi-item">
                                                <a href="{{ route('print.low_stock') }}" target="_blank"
                                                    class="navi-link">
                                                    <span class="navi-icon">
                                ...
                                @if (!Auth::guard('web')->check())
                                    @can('po_create')
                                        ...
                                        <!--end::Button-->
                                        <!--begin::Button-->
                                        {{-- <a href="{{route('purchase-orders.create')}}" class="btn btn-primary font-weight-bolder">
                                <span class="svg-icon svg-icon-md">
                                    <!--begin::Svg Icon -->
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('low-stock.filter') }}" id="filter-from"
                                ...
                                <div class="row mb-6">
                                    ...
                                    <label>Search by units:</label>
                                    <input type="number" class="form-control datatable-input" id="unitSearch" placeholder="Search by units" data-col-index="2">
                                </div>
                                <div class="col-lg-3 mb-lg-0 mb-6">
                                    <label>Search by company:</label>
                                    <select class="form-control selectpicker datatable-input" data-live-search="true" data-size="5" id="companySearch" name="company_id" data-col-index="4">
                                    ...
                                    <div class="col-lg-3 mb-lg-0 mb-6">
                                        <label>Search by company:</label>
                                        <select class="form-control selectpicker datatable-input" data-live-search="true"
                                            data-size="5" id="companySearch" name="company_id" data-col-index="4">
                                            <option value="">Select</option>
                                            @foreach ($companies as $company)
                                    ...
                                    <div class="col-lg-3 mb-lg-0 mb-6">
                                        ...
                                        <select class="form-control selectpicker datatable-input" id="supplier_id"
                                            data-size="5" data-live-search="true" name="supplier_id" data-col-index="4">
                                            <option value="">Select</option>
