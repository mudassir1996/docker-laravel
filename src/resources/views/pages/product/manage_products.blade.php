                ...
                <div class="flex-row-fluid">
                    ...
                    <div class="card card-custom">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="#" type="button" class="dropdown-item"
                                                        data-toggle="modal" data-target="#upload_model">Import Products</a>
                                                    <a href="#" class="dropdown-item">Import Standard Products</a>
                                                </div>
                                            </div>
                                        @endcan
                                    @else
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <a href="#" type="button" class="dropdown-item"
                                                    data-toggle="modal" data-target="#upload_model">Import Products</a>
                                                <a href="{{ route('standard-product') }}" class="dropdown-item">Import
                                                    Standard
                                                    Products</a>
                                            </div>
                                        </div>
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="row mb-6">
                                        <div class="col-lg-2 mb-lg-0 mb-6">
                                            ...
                                            <input type="text" class="form-control datatable-input" id="productSearch"
                                                placeholder="E.g: Nestle" data-col-index="0">
                                        </div>
                                        <div class="col-lg-2 mb-lg-0 mb-6">
                                            <label>Barcode:</label>
                                            <input type="text" class="form-control datatable-input" id="barcodeSearch"
                                                placeholder="E.g: 123456789" data-col-index="1">
                                        </div>
                                        <div class="col-lg-2 mb-lg-0 mb-6">
                                            <label>Status:</label>
                                            <select class="form-control datatable-input" id="statusSearch"
                                                data-col-index="2">
                                        ...
                                        <div class="col-lg-2 mb-lg-0 mb-6">
                                            ...
                                            <select class="form-control datatable-input" id="categorySearch"
                                                data-col-index="3">
                                                <option value="">Select</option>
                                            </select>
                                        </div>
                                        <div class="col-lg-2 mb-lg-0 mb-6">
                                            <label>Company:</label>
                                            <select class="form-control datatable-input" id="companySearch"
                                                data-col-index="4">
                                                <option value="">Select</option>
                                            </select>
                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="symbol symbol-50 flex-shrink-0">
                                                        <div class="symbol-label"> <img class="img-thumb-sm"
                                                                src="{{ Storage::disk('public')->exists('products/' . $product->product_feature_img) ? asset('storage/products/' . $product->product_feature_img) : asset('storage/' . $product->product_feature_img) }}"
                                                                alt="{{ $product->product_title }}"> </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <form action="{{ route('products.destroy', $product->id) }}"
                                                        id="delete_item_form{{ $product->id }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        @if (!Auth::guard('web')->check())
                                                            @can('product_show')
                                                            ...
                                                            @can('product_delete')
                                                                <a class="btn p-0" title="Delete" type="submit"
                                                                    onclick="deleteConfirmation('delete_item_form{{ $product->id }}')"><i
                            ...
                            @else
                                {{-- If there are 0 products in outlet --}}

                                @include('pages.product.first-product-layout')
                            @endif
    ...
    <div class="modal fade" id="upload_model" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form action="{{ route('products.import') }}" enctype="multipart/form-data" method="post"
                    class="add_category">
                    @csrf
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <p>The correct column order is (product_title*, product_description, product_barcode*,
                                product_allow_half*, cost_price*, retail_price*, stock_keeping*, units_in_stock*, sku*,
                                minimum_threshold*, category_id, company_id) and you must follow this.</p>
                        </div>
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <a href="{{ route('download.product-csv') }}"
