                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item">
                            <a href="#" class="text-muted">Edit Outlet</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card card-custom">
                        <div class="card-header flex-wrap py-5">
                            <div class="card-title">
                                <h3 class="card-label">Edit Outlet
                                ...
                                <div class="card-body">
                                    <div class="form-group mb-8">
                                        <div class="alert alert-custom alert-default" role="alert">
                                            ...
                                            <div class="alert-text">The example form below demonstrates common HTML form
                                                elements that receive updated styles from Bootstrap with additional classes.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-xl-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="outlet_title" class="form-control   "
                                                    name="outlet_title" value="{{ $outlet->outlet_title }}"
                                                    placeholder="Outlet Title" />
                                            </div>
                                            <!--end::Input-->
                                        </div>
                                        <div class="col-xl-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control   "
                                                    value="{{ $outlet->outlet_slogan }}" name="outlet_slogan"
                                                    placeholder="Slogan" />
                                            </div>
                                            <!--end::Input-->
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-xl-6">
                                            ...
                                            <div class="form-group">
                                                <label>Phone *</label>
                                                <input type="text" id="outlet_phone" class="form-control   "
                                                    value="{{ $outlet->outlet_phone }}" name="outlet_phone"
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control   "
                                                    value="{{ $outlet->outlet_alt_phone }}" name="outlet_alt_phone"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-xl-6">
                                            ...
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input type="text" class="form-control   "
                                                    value="{{ $outlet->outlet_email }}" name="outlet_email"
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="form-group">
                                                <label>Address</label>
                                                <input type="text" class="form-control   "
                                                    value="{{ $outlet->outlet_address }}" name="outlet_address"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control  " id="kt_datepicker_outlet"
                                                    value="{{ $outlet->outlet_opening_date ?? '' }}"
                                        ...
                                        <div class="col-xl-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control   " id="exampleTextarea"
                                                    ...
                                                    rows="5">{{ $outlet->outlet_description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!-- <input type="hidden" name="registration_details_id" value="1">
                                        <input type="hidden" name="outlet_status_id" value="2">
