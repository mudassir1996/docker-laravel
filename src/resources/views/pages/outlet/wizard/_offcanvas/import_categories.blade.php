<div class="offcanvas offcanvas-right p-10 pb-20" id="kt_offcanvas">
    <div class="offcanvas-header pb-3">
        <div class="d-flex align-items-center justify-content-between mb-5">
            <h3 class="font-weight-bold m-0">
                Categories
            </h3>
            <button type="button" class="btn btn-primary" data-checked="0" id="select-all-categories">Select
                All</button>
            {{-- <a href="#" class="btn btn-xs btn-icon btn-light btn-hover-primary" id="kt_offcanvas_close">
        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                @foreach ($standard_categories as $standard_category)
                    <!--begin::Item-->
                    <div class="d-flex align-items-center mb-6 categories">
                        ...
                        <div class="d-flex flex-column flex-grow-1 py-2 ml-4">
                            <a href="#"
                                class="text-dark-75 font-weight-bold text-hover-primary font-size-lg mb-1 category-title">{{ $standard_category->title }}</a>
                            <input type="hidden" class="business-type-id"
                                value="{{ $standard_category->business_type_id }}">
                        </div>
                        <!--end::Text-->
                        <!--begin::Checkbox-->
                        <label class="checkbox checkbox-lg checkbox-primary flex-shrink-0 m-0 mr-4">
                            <input type="checkbox" name="categories[]" class="categories-check"
                                value="{{ $standard_category->id }}">
                            <span></span>
                        </label>
                        <!--end::Checkbox-->
                    </div>
