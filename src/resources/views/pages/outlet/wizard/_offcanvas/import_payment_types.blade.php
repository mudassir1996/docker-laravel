<div class="offcanvas offcanvas-right p-10 pb-20" id="kt_offcanvas_payment_type">
    <div class="offcanvas-header pb-3">
        <div class="d-flex align-items-center justify-content-between mb-5">
            <h3 class="font-weight-bold m-0">
                Payment Types
            </h3>
            {{-- <a href="#" class="btn btn-xs btn-icon btn-light btn-hover-primary" id="kt_offcanvas_payment_type_close">
                <i class="ki ki-close icon-xs text-muted"></i>
            </a> --}}
            <button type="button" class="btn btn-primary" data-checked="0" id="select-all-payment-types">Select
                All</button>
        </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                @foreach ($standard_payment_types as $standard_payment_type)
                    <!--begin::Item-->
                    <div class="d-flex align-items-center mb-6 payment_types">
                        <!--begin::Text-->
                        <div class="d-flex flex-column flex-grow-1 py-2 ml-4">
                            <a href="#"
                                class="text-dark-75 font-weight-bold text-hover-primary font-size-lg mb-1 payment-title">{{ $standard_payment_type->title }}</a>
                        </div>
                        <!--end::Text-->
                        <!--begin::Checkbox-->
                        <label class="checkbox checkbox-lg checkbox-primary flex-shrink-0 m-0 mr-4">
                            <input type="checkbox" name="payment_types[]" class="payment-type-check"
                                value="{{ $standard_payment_type->id }}">
                            <span></span>
                        </label>
                        <!--end::Checkbox-->
                    </div>
