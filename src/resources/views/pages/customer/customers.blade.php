                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item">
                            <a href="#" class="text-muted">All Customers</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                                    ...
                                    <button type="button" class="btn btn-light-primary font-weight-bolder dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                            ...
                                            <ul class="navi flex-column navi-hover py-2">
                                                ...
                                                <li class="navi-item">
                                                    <a href="{{ route('print.customers') }}" target= "_blank" class="navi-link">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="symbol symbol-75  flex-shrink-0">
                                                <div class="symbol-label"> <img class="h-100 align-self-end" src="{{Storage::disk('public')->exists('customers/'.$customer->customer_feature_img)?asset('storage/customers/'.$customer->customer_feature_img):asset('storage/'.$customer->customer_feature_img)}}" alt="{{$customer->customer_name}}"> </div>
                                            </div>

                                        </td>
                                        <td><a href="{{route('customers.show', $customer->id)}}" class="font-weight-bolder">{{$customer->customer_name}}</a></td>
                                        <td>{{substr($customer->customer_description, 0, 40)}}...</td>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('customers.destroy',$customer->id)}}" id="delete_item_from{{$customer->id}}" method="post">
                                                ...
                                                @can('customer_show')
                                                <a class="btn p-0" title="View" href="{{ route('customers.show',$customer->id)}}">
                                                    <i class="text-primary h3 la la-eye"></i>
                                                </a>
                                                @endcan

                                                @can('customer_edit')
                                                <a class="btn p-0" title="Edit" href="{{ route('customers.edit',$customer->id)}}">
                                                    <i class="text-success h3 la la-edit"></i>
                                                </a>
                                                @endcan

                                                @can('customer_delete')
                                                <a class="btn p-0" title="Delete" onclick="deleteConfirmation('delete_item_from{{$customer->id}}')"><i class="text-danger h3 la la-trash"></i></a>
                                                @endcan
