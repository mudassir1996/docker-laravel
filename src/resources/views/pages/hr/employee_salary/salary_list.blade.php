                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            ...
                            <a href="" class="text-muted">All Employees Salaries</a>
                    ...
                    <div class="card card-custom">
                        ...
                        <div class="card-header flex-wrap py-5">
                            ...
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Employees Salaries

                                    <span class="d-block text-muted pt-2 font-size-sm">Manage Employees Salaries</span>
                                    ...
                                    @if (!$employee_salaries->isEmpty())
                                        ...
                                        @foreach ($employee_salaries as $employee_salary)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $employee_salary->salary_type_title }}</td>

                                                <td>{{ $employee_salary->salary_amount }}</td>

                                                <td>{{ $employee_salary->per_hour_wage }}</td>

                                                <td>{{ $employee_salary->working_hours_per_day }}</td>

                                                <td>{{ $employee_salary->joining_date }}</td>

                                                <td>{{ $employee_salary->outlet_title }}</td>

                                                <td>{{ $employee_salary->starting_date }}</td>

                                                <td>{{ $employee_salary->created_at }}</td>

                                                <td>{{ $employee_salary->updated_at }}</td>

                                                <td>

                                                    <form action="{{ route('employee-salary.destroy', $employee_salary->id) }}"
                                                        id="delete_item_from{{ $employee_salary->id }}" method="post">
                                                        ...
                                                        @if (!Auth::guard('web')->check())
                                                            ...
                                                            @endcan
                                                                ...
                                                                @can('employee_salary_delete')

                                                                    <a class="btn p-0" title="Delete"
                                                                        onclick="deleteConfirmation('delete_item_from{{ $employee_salary->id }}')"><i
