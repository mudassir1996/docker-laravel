                                    ...
                                    <div class="row mb-17">
                                        ...
                                        <div class="col-xxl-12 ">
                                            <h2 class="font-weight-bolder text-dark mb-7" style="font-size: 32px;">
                                                {{$party_account->party_title}}
                                            </h2>
                                            <div class="font-size-h2 mb-7 text-dark-50">Payment
                                                <span class="text-info font-weight-boldest ml-2">PKR {{$party_account->amount}}</span>
                                            </div>
                                            <div class="line-height-xl">{{$party_account->description}}</div>
                                        </div>
                                    </div>
                                    <div class="row mb-6">
                                        <!--begin::Info-->
                                        ...
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                                ...
                                                <span class="text-muted font-weight-bolder font-size-lg">
                                                    {{ ucfirst($party_account->payment_type_title) }}
                                                </span>
                                            </div>
                                        </div>
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                                ...
                                                <span class="text-muted font-weight-bolder font-size-lg">{{$party_account->payment_date}}</span>
                                            </div>
                                        </div>
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                                <span class="text-dark font-weight-bold mb-4">Order ID</span>
                                                <span class="text-muted font-weight-bolder font-size-lg">{{$party_account->order_id}}</span>
                                            </div>
                                        </div>
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                        ...
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                                ...
                                                <span class="text-muted font-weight-bolder font-size-lg">{{$party_account->created_at}}</span>
                                            </div>
                                        </div>
                                        <div class="col-6 col-md-4">
                                            <div class="mb-8 d-flex flex-column">
                                                <span class="text-dark font-weight-bold mb-4">Updated At</span>
                                                <span class="text-muted font-weight-bolder font-size-lg">{{$party_account->updated_at}}</span>
                                            </div>
                                        </div>
                                        <!--end::Info-->
                                    </div>
