        ...
        <div class="form-group mb-3 row align-items-center">
            <div class="col-xl-2 pr-0">
                ...
                <input type="text" name="" id="" style="height:30px"
                    class="form-control p-2 currency text-left recievable" placeholder="Total Recievable" disabled>
            </div>
            <div class="col-xl-2 pr-0">
                <label for="">Payable to Airline</label>
                <input type="text" name="" id="" style="height:30px"
                    class="form-control p-2 currency text-left payable-to-airline" placeholder="Payable to Airline"
                    disabled>
            </div>
            <div class="col-xl-2 pr-0">
                <label for="">Other Payable</label>
                <input type="text" name="" id="" style="height:30px"
                    class="form-control p-2 currency text-left other-payable" placeholder="Other Payable" disabled>
            </div>
            <div class="col-xl-2 pr-0">
                <label for="">Total Payable</label>
                <input type="text" name="" id="" style="height:30px"
                    class="form-control p-2 currency text-left total-payable" placeholder="Total Payable" disabled>
            </div>
            <div class="col-xl-2 pr-0">
                <label for="">Total Income</label>
                <input type="text" name="" id="" style="height:30px"
                    class="form-control p-2 currency text-left total-income" placeholder="Total Income" disabled>
            </div>
            ...
            <div class="col-xl-3 pr-0">
                ...
                <select class="form-control selectpicker payment-type" data-live-search="true" id="payment_type">
                    ...
                    {{-- @foreach ($payment_types as $payment_type)
                        <option data-value="{{ $payment_type->value }}"
                            {{ $payment_type->value == 0 ? 'selected' : '' }} value="{{ $payment_type->id }}">
