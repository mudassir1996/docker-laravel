            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="#" class="text-muted">Add Tax</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card card-custom">
                        <div class="card-header flex-wrap py-5">
                            <div class="card-title">
                                <h3 class="card-label">Add Outlet Tax
                        ...
                        <div class="card-body">
                            <!--begin::Form-->
                            <form method="post" action="{{ route('outlet-taxes.store') }}" id="add_tax_form"
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group">
                                                ...
                                                <input autocomplete="off" type="text" name="tax_title" id="tax_title"
                                                    class="form-control  " value="{{ old('tax_title') }}"
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group">
                                                ...
                                                <input autocomplete="off" type="text" name="tax_value" id="tax_value"
                                                    class="form-control  " value="{{ old('tax_value') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control selectpicker" id="tax_type" name="tax_type">
                                                    <option value="percentage"
                                                        {{ old('tax_type') == 'percentage' ? 'selected' : '' }}>Percentage
                                                    </option>
                                                    <option value="value" {{ old('tax_type') == 'value' ? 'selected' : '' }}>Value
                                                    </option>
                                                </select>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control selectpicker" id="tax_status" name="tax_status">
                                                    <option value="active" {{ old('tax_status') == 'active' ? 'selected' : '' }}>
                                                        Active</option>
                                                    <option value="inactive"
                                                        {{ old('tax_status') == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                                </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control   " id="exampleTextarea" name="tax_description"
                                            rows="5">{{ old('tax_description') }}</textarea>
                                    </div>
