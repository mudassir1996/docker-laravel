...
@section('title', 'Expense Category Transactions')
@section('content')
<!--begin::Subheader-->
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="/outlets/reports/expense-report" class="text-muted">Expense Categories Report</a>
                    </li>
                    <li class="breadcrumb-item">
                        <a href="#" class="text-muted">Expense Category Transaction List</a>
                    </li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">Expense Transactions of <i><b>"{{ $category->title }}" </b></i> Category
                        ...
                        <div class="card-toolbar">
                            ...
                            <!--begin::Button-->
                            <a href="{{route('expense-transaction.create')}}" class="btn btn-primary font-weight-bolder">
                                <span class="svg-icon svg-icon-md">
                                    <!--begin::Svg Icon -->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div class="card-body">
                        <!--begin: Datatable-->
                        <table class="table table-separate nowrap table-head-custom table-checkable" id="kt_datatable_expense_transaction">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                @foreach($category_transactions as $transaction)
