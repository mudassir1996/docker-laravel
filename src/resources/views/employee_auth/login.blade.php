        ...
        <div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
            ...
            <div class="d-flex flex-column-fluid flex-center">
                ...
                <div class="login-form login-signin">
                    <!--begin::Form-->
                    <form class="form" method="POST" action="{{ route('employee.login') }}" novalidate="novalidate" id="kt_login_signin_form">
                        @csrf
                        <!--begin::Title-->
                        ...
                        <div class="form-group">
                            <div class="d-flex justify-content-between mt-n5">
                                ...
                                {{-- <a href="{{route('employee_password.request')}}" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5">Forgot Password ?</a> --}}
                            </div>
                            <input class="form-control form-control-solid font-size-h6 h-auto py-5 px-6 rounded-lg password @error('email') is-invalid @enderror" type="password" name="password" autocomplete="off" placeholder="Password" />
