...
<div class="d-flex flex-column flex-root">
    <!--begin::Error-->
    <div class="d-flex flex-row-fluid flex-column p-10 p-sm-30" style="background-color: #D4192C;">
        <div class="d-flex flex-row-fluid flex-column justify-content-center align-items-center text-center text-white pb-40">
            <h1 class="display-1 text-light font-weight-boldest mb-6">403!</h1>
            <h1 class="display-4 text-light font-weight-boldest mb-2">You are not allowed to be here.</h1>
            <span class="h3 text-light font-weight-bold mb-8">Please contact your admin.</span>
