...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-row-fluid flex-column bg-dark p-10 p-sm-30">
        <div class="d-flex flex-row-fluid flex-column justify-content-center align-items-center text-center text-white pb-40">
            <h1 class="display-1 text-light font-weight-boldest mb-6">500!</h1>
            <h1 class="display-4 text-light font-weight-boldest mb-2">Something went wrong here.</h1>
            <span class="h3 text-light font-weight-bold mb-8">We're working on it and it'll get fixed soon.</span>
